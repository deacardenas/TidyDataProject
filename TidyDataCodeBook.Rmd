...
```{r results = 'asis'} 
ColumnName <- c("Time","Freq","Body","Gravity","Accelerometer","Gyroscope","Jerk","Magnitude","Mean", "StdDev","X/Y/ZAxis")
Description <- c("Signal in time domain, captured at a constant rate of 50Hz.", "Signal in the frequency domain, calculated as the Fast Fourier Transform of time-domain signals.", "Indicates measurements due to the body of the subject, derived from the phone's accelerometer signal.", "Indicates measurements due to gravity, derived from the phone's accelerometer signal.", "Indicates measurements derived from the phone's accelerometer signal.", "Indicates measurements derived from the phone's gyroscope signal.", "Calculated by deriving the body linear acceleration or angular velocity in time.", "Indicates the magnitude of a 3-dimensional measurement.", "Indicates that this is the mean calculated from all signals of this type during the experiment.", "Indicates that this is the standard deviation calculated from all signals of this type during the experiment.", "Indicates the corresponding axis value for 3-dimensional variables.")
data <- cbind(ColumnName, Description)
knitr::kable(data)
``` 
